...
// useRouter brauchen wir gar nicht mehr zwingend, aber kann drin bleiben
...
export default function KitchenLogin() {
  ...
  const handleLogin = () => {
    if (password === "schnitzel") {
      ...
      // 2. Button-Feedback (optional, damit man sieht, dass was passiert)
      setError("Erfolgreich! Weiterleitung...");

      // 3. WICHTIGE ÄNDERUNG: Harte Weiterleitung
      // Das zwingt den Browser, den Cookie sofort zu verarbeiten
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-900 text-white p-4">
      <div className="w-full max-w-md bg-slate-800 p-8 rounded-2xl border border-slate-700 text-center shadow-2xl">
        <h2 className="text-3xl font-bold mb-2">Küchen-Login</h2>
        ...
        <div className="space-y-4">
          <input
            ...
            onChange={(e) => {
              ...
              // Fehler wegbekommen, wenn man tippt (außer es ist die Erfolgsmeldung)
          ...
          {error && (
            <div className={`text-sm font-bold p-2 rounded border ${
